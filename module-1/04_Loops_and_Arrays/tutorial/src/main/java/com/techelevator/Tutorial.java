...
if (highestTemperatureValue == forecastTemperatures[1]) {
    ...
    System.out.println("The highest temperature is in " + highestTemperatureIndex + " days.");
}
    }
}
