...
public class Lecture {
    ...
    */
    public boolean returnTrueWhenGreaterThanFive(int number) {
        if (number > 5) {
            // if number is greater than 5, then this block runs
            return true;
        } else {
            // if number is less than or equal to 5, then this block runs

        }
        return false;
    }

    public int returnTwoNumbersAdded(int x, int y) {
        return x + y;
    }
    ...
    */
    public String returnFizzIfThreeUsingTernary(int number) {
        ...
        // <boolean expression> ? <true_code> : <false_code>
    ...
    */
    ...
    /*
    17. Write a method that returns your grade given the percentage of questions that you answered correctly.
     */

    public int calculatedGrade(double percentCorrectAnswers) {
        if(percentCorrectAnswers >= 90) {
            return 3;
        }

        if(percentCorrectAnswers >= 50) {
            return 2;
        }

        if(percentCorrectAnswers >= 25) {
            return 1;
        }
    ...
    public void doStuff() {
        ...
        int myCalculatedGrade = calculatedGrade(myScore);
