...
public class Exercises {
	...
	public boolean parrotTrouble(boolean talking, int hour) {
		return talking && (hour < 7.0 || hour > 20.0);
	}
	...
	public int dateFashion(int you, int date) {
		if ((you >= 8 && date > 2) || (date >= 8 && you > 2)) {
			return 2;
		} if (( (you < 8 && you >2) && date > 2) || ( (date < 8 && date >2) && you > 2) ){
			return 1;
		}
		return 0;
	}
    ...
    public String yourCakeAndEatItToo(double mealAmount, boolean isBirthday) {
		if ((mealAmount <= 10 && !isBirthday) || (mealAmount <= 5 && isBirthday)) {
			return "standard";
		} if ( (mealAmount <= 15 && mealAmount > 10 && !isBirthday) || (mealAmount <= 10 && mealAmount >= 5 && isBirthday) ) {
			return "special";
		} if (mealAmount > 15 || (mealAmount >= 10.01 && isBirthday)) {
			return "ginormous";
		} return "void";
    }
	/*if (isBirthday) {
	 ...
	 */
	 public String alarmClock(int day, boolean vacation) {
		 if (vacation && (day == 0 || day ==6)) {
			 return "off";
		 } if (vacation && (day >= 1 || day <= 5) || ((day == 0 || day == 6) && !vacation)) {
			 return "10:00";
		 }
		return "7:00";
	}
