...
VALUES ('Step Brothers', 'Two brothers go in search for friendship', 'Two brothers', 'some path', 'https://www.step-brothers.com', '2008-01-10', 90, null, null);

INSERT INTO movie (title, overview, tagline, poster_path, home_page, release_date, length_minutes, director_id, collection_id)
VALUES ('Avatar', '', '', '', '', '2000-02-25', 180, (SELECT person_id FROM person WHERE person_name = 'James Cameron'), null);

INSERT INTO movie (title, overview, tagline, poster_path, home_page, release_date, length_minutes, director_id, collection_id)
VALUES ('Titanic', '', '', '', '', '1995-02-25', 200, (SELECT person_id FROM person WHERE person_name = 'James Cameron'), null);
