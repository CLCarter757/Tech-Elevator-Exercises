 ...
 * 
 * @param{string[]} array a series of strings to prepend
 * @return{string[]} a new array with prepended strings
 */
...
function getFullAddressesOfProperties(array) {
    return array.map(address => address.streetNumber + " " + address.streetName + " " + 
...
function getSumOfSubArrayValues(arrays) {
    ...
    return arrays.reduce((accumulator1, current1) => {
        return accumulator1 + current1.reduce((accumulator, current) => {
